...
@Component({
  selector: 'app-sidenav-account-setting',
  imports: [
    CommonModule,
    RouterModule,
    NzIconModule,
  ...
  templateUrl: './sidenav-account-setting.html',
  styleUrl: './sidenav-account-setting.css',
})
export class SidenavAccountSetting {
    ...
    menus = [
      ...
      },
      {
        ...
        items: [
          ...
          { label : 'Preference Settings', link: '/preference-settings' },
